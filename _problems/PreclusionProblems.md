...
Guy then files a lawsuit in Hudson federal court {% sidenote "sidenote-id" "Assume that the court has personal jurisdiction over Elke and subject matter jurisdiction based on diversity of citizenship." %} against Elke Corp., alleging that a design defect and lack of a warning against operation of the mower indoors or while intoxicated were responsible for his injury. 
